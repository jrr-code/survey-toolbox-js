...
const {getDeltasFromCoordinates, getDistance2dFromDeltas, getDistance3dFromDeltas} = require("./CommonCalculations");
const {getBearingFromDeltas} = require("./BearingFromDeltas");
